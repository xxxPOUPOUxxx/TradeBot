...
#[derive(Debug)]
pub struct TradeBotProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TradeBotProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TradeBot processing");
    
    let mut processor = TradeBotProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TradeBotProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TradeBotProcessor::new(false);
